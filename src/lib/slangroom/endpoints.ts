...
export const servicesByOrganization = [
	'api/collections/services/records?filters=(organization="',
	'")'
];
...
export const webauthnSessions = [
	'api/collections/sessionDataWebauthn/records?filter=(user="',
	'")'
];
