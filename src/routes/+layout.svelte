...
<svelte:head>
	...
	<script
		type="module"
		src="https://cdn.jsdelivr.net/npm/@didroom/components@1.22/dist/didroom-components/didroom-components.esm.js"
	></script>
	<link
		rel="stylesheet"
		href="https://cdn.jsdelivr.net/npm/@didroom/components@1.22/dist/didroom-components/didroom-components.css"
	/>
</svelte:head>
<svelte:window
