<script lang="ts">
	...
	import { regenerateKeypair } from '$lib/keypairoom/keypair';
...
<form on:submit={submit}>
	...
	<ion-item>
		<ion-text color="secondary"><a href="/login" >Do you want to login answering your personal question? tap here</a></ion-text>
	</ion-item>
</form>
